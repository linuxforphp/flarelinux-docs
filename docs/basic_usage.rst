...
command in the terminal, and wait for the server to finish bootstrapping (might take some time)::
    ...
    $ docker run -dit --restart=always -e FLARE_BIND_ADDRESS=0.0.0.0 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.2.0-1.12.0 flare --songbird
...
command in the terminal, and wait for the server to finish bootstrapping (might take some time)::
    ...
    $ docker run -dit --restart=always -e FLARE_BIND_ADDRESS=0.0.0.0 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.2.0-1.12.0 flare --songbird-validator
...
$ docker run -dit --restart=always -e FLARE_BIND_ADDRESS=0.0.0.0 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.2.0-1.12.0 flare --flare-observer
...
command in the terminal, and wait for the server to finish bootstrapping (might take some time)::
    ...
    $ docker run -dit --restart=always -e FLARE_BIND_ADDRESS=0.0.0.0 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.2.0-1.12.0 flare --flare-validator
...
command in the terminal, and wait for the server to finish bootstrapping (might take a few minutes)::
    ...
    $ docker run -dit --restart=always -e FLARE_BIND_ADDRESS=0.0.0.0 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.2.0-1.12.0 flare --flare-coston1
...
You can also run the server in interactive mode by removing the 'd' option, like so::
    ...
    $ docker run -it --rm -e FLARE_BIND_ADDRESS=0.0.0.0 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.2.0-1.12.0 flare --flare-coston1
...
command in the terminal, and wait for the server to finish bootstrapping (might take a few minutes)::
    ...
    $ docker run -dit --restart=always -e FLARE_BIND_ADDRESS=0.0.0.0 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.2.0-1.12.0 flare --flare-coston2
...
If you prefer, you can run a local Flare node, by running the following command instead::
    ...
    $ docker run -it --rm -e FLARE_BIND_ADDRESS=127.0.0.1 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.2.0-1.12.0 flare
