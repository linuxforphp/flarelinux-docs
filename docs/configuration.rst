...
.. list-table:: Environment Variables
   ...
   * - FLARE_DATA_DIR
     - Directory where the data files are stored, including the LevelDB database file (--db-dir). The default is '/home/flareuser/.flare' within the container. This directory can be shared with the host computer (please see the 'Sharing Files' section).
   * - FLARE_PUBLIC_IP
